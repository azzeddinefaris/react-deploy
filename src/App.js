...
function App() {
  return (
    ...
    <Layout>
        <Header className="header-style" title={<Link style={{textDecoration: 'none', color:'white'}} to="/"><img className="logo  align-self-center" src={require('./composants/images/white_logo.png')} alt="logo-accuiel"/> </Link>} scroll>
            <Navigation>
